...
<head>
    ...
    <title>Resolver || Account Verification</title>
...
<section id="wrapper">
    ...
    <div class="login-register" style="background-image:url('{{asset('backend/images/background/login-register.jpg')}}');">
        <div class="login-box card">
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" action="{{route('account.verification.post', encrypt($user->id))}}" method="POST">
                    @csrf
                    ...
                    <h3 class="text-center m-b-20">Verify Account</h3>
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="verification_code" value="{{old('verification_code')}}" placeholder="Enter Verification Code...">
                        </div>
